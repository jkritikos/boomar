...
<section id="top_content" class="container clearfix">
		...
		<h1 class="page-title">Digital Strategy</h1>

	
</section>

<div class="imgLiquidFill imgLiquid" style="width:100%; height:450px;">
    <img src="/img/main_image_4.jpg" alt="" id="background" />
    <div style="position:relative; width:50%; margin-left:32%; margin-right:auto; float:none; padding-top:5%">
        <h1 style="color:white; font-size: 2.75em;">We strive to plan a <span style="color:#70d9fc">strategy</span> that<br> will shape your digital footprint.</h1>
    </div>
</div>
